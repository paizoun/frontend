...
export class TeamService {
  ...
  protected convertDateFromClient(team: ITeam): ITeam {
    const copy: ITeam = Object.assign({}, team, {
      createTeamDate: team.createTeamDate && team.createTeamDate.isValid() ? team.createTeamDate.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.createTeamDate = res.body.createTeamDate ? moment(res.body.createTeamDate) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((team: ITeam) => {
        team.createTeamDate = team.createTeamDate ? moment(team.createTeamDate) : undefined;
      });
    }
    return res;
  }
