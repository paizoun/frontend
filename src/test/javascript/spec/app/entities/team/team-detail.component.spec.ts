...
describe('Component Tests', () => {
  describe('Team Management Detail Component', () => {
    ...
    const route = ({ data: of({ team: new Team('9fec3727-3421-4967-b213-ba36557ca194') }) } as any) as ActivatedRoute;
    ...
    describe('OnInit', () => {
      it('Should load team on init', () => {
        ...
        // THEN
        expect(comp.team).toEqual(jasmine.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
      });
    });
