  ...
  describe('Team Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new Team('9fec3727-3421-4967-b213-ba36557ca194')],
            headers
          })
        )
      );
      ...
      expect(comp.teams && comp.teams[0]).toEqual(jasmine.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
